package ru.sbrf.sbererp.core.common.reactive.unified.audit.adapter;
 ...
 * @param params    мапа {@link ParamHolder} → извлечённая строка.
...
public record EventAdapter(
  ...
  /**
   * Нормализует мапу {@link ParamHolder} → значение, если билдер её не задал.
   */
  public EventAdapter {
  ...
  /**
   * Кладёт параметр в мапу {@link ParamHolder} → значение, если {@code value} непустое.
   *
