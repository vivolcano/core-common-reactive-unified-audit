 ...
 * <p>
 * Вызывается из {@link ru.sbrf.sbererp.core.common.reactive.unified.audit.filter.AuditWebFilter}
 * после цепочки (успех и ошибка). Claims кладутся в атрибут
 * {@link ru.sbrf.sbererp.core.common.reactive.unified.audit.utils.AuditExchangeAttributeNames#TOKEN_PARAMS}
 * до синхронных экстракторов.
 */
@Service
